...
class NetAppRestClient(object):
    ...
    @na_utils.trace
    def soft_delete_volume(self, volume_name, force_delete, in_prune=False):
    ...
    @na_utils.trace
    def delete_volume(self, volume_name, force_delete=False, in_prune=False):
        """Deletes a volume."""
        return self.soft_delete_volume(volume_name, force_delete=force_delete,
                                       in_prune=in_prune)
    ...
    def prune_deleted_volumes(self):
        ...
        for record in records:
            ...
            if clones:
                ...
                ret = client.delete_volume(vol_name, in_prune=True)
