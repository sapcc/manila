...
quota_opts = [
    ...
    cfg.IntOpt('share_server_replicas',
               default=10,
               help='Number of share-server-replicas allowed per project.',
               deprecated_group='DEFAULT',
               deprecated_name='quota_share_server_replicas'),
...
resources = [
    ...
    ReservableResource('replica_gigabytes', '_sync_replica_gigabytes',
                       'replica_gigabytes'),
    ReservableResource('share_server_replicas',
                       '_sync_share_server_replicas',
