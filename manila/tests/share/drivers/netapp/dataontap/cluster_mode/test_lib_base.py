...
class NetAppFileStorageLibraryTestCase(test.TestCase):
    ...
    # })
    # @ddt.unpack
    # def test_validate_volume_for_manage_invalid_volume(self, attribute, value):  # nopep8
    #
    ...
    # def test_validate_volume_for_manage_snapmirror_relationships_present(self):  # nopep8
    #
    #     vserver_client = mock.Mock()
    #     vserver_client.volume_has_luns.return_value = False
    #     vserver_client.volume_has_junctioned_volumes.return_value = False
    #     vserver_client.volume_has_snapmirror_relationships.return_value = True  # nopep8
    #
    #     self.assertRaises(exception.ManageInvalidShare,
    #                       self.library._validate_volume_for_manage,
    #                       fake.FLEXVOL_TO_MANAGE,
