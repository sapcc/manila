...
SUPPORTED_SHARE_PROTOCOLS = (
    'NFS', 'CIFS', 'MULTI', 'GLUSTERFS', 'HDFS', 'CEPHFS', 'MAPRFS', 'LUSTRE')
...
SHARE_STATUSES = (
    STATUS_CREATING,
    STATUS_CREATING_FROM_SNAPSHOT,
    STATUS_DELETING,
    STATUS_DEFERRED_DELETING,
    STATUS_DELETED,
    STATUS_ERROR,
    STATUS_ERROR_DELETING,
    STATUS_ERROR_DEFERRED_DELETING,
    STATUS_AVAILABLE,
    STATUS_MANAGING,
    STATUS_MANAGE_ERROR,
    STATUS_UNMANAGING,
    ...
    STATUS_UNMANAGED,
    STATUS_EXTENDING,
    STATUS_EXTENDING_ERROR,
    STATUS_SHRINKING,
    STATUS_SHRINKING_ERROR,
    STATUS_MIGRATING,
    STATUS_MIGRATING_TO,
    STATUS_SHRINKING_POSSIBLE_DATA_LOSS_ERROR,
    ...
    STATUS_RESTORING,
    STATUS_REVERTING,
    STATUS_REVERTING_ERROR,
    STATUS_AWAITING_TRANSFER,
    STATUS_BACKUP_CREATING,
    STATUS_BACKUP_RESTORING,
    STATUS_BACKUP_RESTORING_ERROR,
    STATUS_ENSURING,
